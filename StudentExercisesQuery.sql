...
--	LEFT JOIN Exercise e on se.ExerciseId = e.Id
	--works but getting polly gray exercises??

--Return a list of student names along with the count of exercises assigned to each student ***NEED TO FINISH
